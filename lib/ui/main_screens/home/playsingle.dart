  ...
  void _initializeAndPlay(int index, {bool clicked}) async {
    ...
    controller
      ..initialize().then((_) {
        ...
        clicked == true ? controller.play() : controller.pause();
        setState(() {});
      });
  }
        ...
        child: Row(
          ...
          children: <Widget>[
           /*  Padding(
              ...
              child: clip['contentData'].startsWith("http")
                  ? Image.network("${clip['contentData']}".replaceAll(".mp4" , '.jpg'), width: 70, height: 50, fit: BoxFit.fill)
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("${clip['title']}", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ),
                   /*  Padding(
